...
const mockEvents = [
  {
    ...
    ticketTiers: [{ name: "Regular", price: 2500, description: "Access to all conference sessions and materials." }],
  ...
  },
  {
    ...
    ticketTiers: [{ name: "Entry", price: 1000, description: "General admission to the festival grounds." }],
  ...
  },
  {
    ...
    ticketTiers: [
        { name: "Student", price: 5000, description: "Access to all sessions." },
        { name: "VIP", price: 15000, description: "Includes front-row seating and a networking lunch with speakers." }
    ],
  ...
  },
  {
    ...
    ticketTiers: [
        { name: "Regular", price: 15000, description: "Standard entry with a three-course meal." },
        { name: "Table of 10", price: 140000, description: "A full, reserved table for you and your friends." },
    ],
  ...
  },
   {
    ...
    time: "48 Hours",
    location: "ICT Centre",
    ticketTiers: [{ name: "Participation", price: 0, description: "Access for one participant. Includes meals." }],
  ...
  },
   {
    ...
    ticketTiers: [{ name: "Gate Fee", price: 1500, description: "Standard entry." }],
