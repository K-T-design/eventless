...
const mockEvents = [
  {
    ...
    ticketTiers: [{ name: "Regular", price: 2500 }],
  ...
  },
  {
    ...
    ticketTiers: [{ name: "Entry", price: 1000 }],
  ...
  },
  {
    ...
    ticketTiers: [
        ...
        { name: "Table of 10", price: 140000, description: "A full table for you and your friends." },
    ],
  ...
  },
   {
    ...
    ticketTiers: [{ name: "Gate Fee", price: 1500 }],
